...
else if($_SESSION['userid']=="groovejumat@naver.com") {
?>
    ...
    <div class="card">
        <form method = "post" action = "comment_action.php" id="nameform">
            <table  style="padding-top:50px" align = center width=700 border=0 cellpadding=2 >
                <tr>
                    <td height=50 align= center bgcolor=#ccc><span style="color: white; ">comment</span></td>
                </tr>
                <tr>
                    <td bgcolor=white>
                        <table class = "table2">
                        ...
                        <div class="view_btn">
                            <button class="view_btn1" type="submit" form="nameform" value="Submit">Comment</button>
                        </div>
                    </td>
                </tr>
            </table>
